...
- (void)setTextHeightChangedBlock:(TDTextHeightChangedBlock)textHeightChangedBlock {
...
- (UITextView *)placeholderView {
    if (!_placeholderView) {
        ...
        _placeholderView.font = [UIFont systemFontOfSize:16.0];
